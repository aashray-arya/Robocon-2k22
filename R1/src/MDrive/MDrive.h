...
void Drive::initialize()
{
    ...
    void Drive::move(int R, float theta, float _head = 0.0, float w = 0)
    {
        ...
        float V1 = (comp.Vx + comp.Vy - 181*comp.W - 275.25*comp.W);
        float V2 = (comp.Vx - comp.Vy + 181*comp.W + 275.25*comp.W);
        float V3 = (comp.Vx - comp.Vy - 181*comp.W - 275.25*comp.W);
        float V4 = (comp.Vx + comp.Vy + 181*comp.W + 275.25*comp.W);
